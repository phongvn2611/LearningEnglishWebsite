...
questionApi.delete('/delete-question-by-id/:id',authentication, questionController.deleteByListenId);
questionApi.delete('/delete-question-by-quiz/:id',authentication, questionController.deleteById);
