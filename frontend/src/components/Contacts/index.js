      ...
      <footer id="footer">
        <div className="container">
          ...
          <div className="row py-5 my-4">
            ...
            <div className="container">
              <a
                href="https://www.facebook.com/tranphuonglinh1507/"
                target="_blank"
                title="Learn English on Facebook"
              >
                <FaFacebookSquare
                  style={{ height: "30px", width: "30px", color: "#fffff5" }}
                />
              </a>
              <span> </span>
              <a
                href="https://www.facebook.com/tranphuonglinh1507/"
                target="_blank"
                title="Learn English on Twitter"
              >
                <FaMailBulk
                  style={{ height: "30px", width: "30px", color: "#fffff5" }}
                />
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-7">
                <span style={{ fonSize: "30px", color: "#fffff5" }}>
                  © Copyright Learn English Network - All Rights Reserved
                </span>
                <br />
                <span style={{ fonSize: "30px", color: "#fffff5" }}>
                  {" "}
                  These pages are best viewed using the latest version of
